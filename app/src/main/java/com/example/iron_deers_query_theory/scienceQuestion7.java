...
public class scienceQuestion7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SA1 =  findViewById(R.id.sq7_1);
        SA2 = findViewById(R.id.sq7_2);
        SA3 = findViewById(R.id.sq7_3);
        SA4 = findViewById(R.id.sq7_4);
        ...
        SA2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(scienceQuestion7.this, scienceQuestion8.class);
