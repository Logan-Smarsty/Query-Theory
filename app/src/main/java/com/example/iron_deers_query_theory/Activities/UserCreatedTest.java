...
public class UserCreatedTest extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            Intent intent = new Intent(UserCreatedTest.this, CategoryFragment.class);
        ...
        binding.NextBtn.setOnClickListener(v ->
        {
            ...
            {
                Intent intent = new Intent(UserCreatedTest.this, ScoresFragment.class);
    ...
    private void resetTimer()
    {
        timer = new CountDownTimer(10000, 1000) {
            ...
            {
                Dialog dialog = new Dialog(UserCreatedTest.this);
